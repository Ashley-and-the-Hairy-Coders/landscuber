      ...
      <div class="form-group">
        ...
        <div v-for="Address in Addresses" :key="Address._id" class="mb-4">
          ...
          <div class="d-flex ml-3">
            <div class="align-self-center text-capitalize">Yard Size: {{Address.yardSize}}</div>
            <div class="dropdown">
              <button
              ...
              <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <a class="dropdown-item" @click.prevent="Address.yardSize = `small`">Small &#8804; 5,000 sqft</a>
                <a
                  class="dropdown-item"
                  @click.prevent="Address.yardSize = `medium`"
                >Medium - 10,000 sqft - 5,001 sqft</a>
                <a
                  class="dropdown-item"
                  @click.prevent="Address.yardSize = `large`"
                >Large - 1/2 Acre - 10,000 sqft</a>
                <a
                  class="dropdown-item"
                  @click.prevent="Address.yardSize = `x-large`"
